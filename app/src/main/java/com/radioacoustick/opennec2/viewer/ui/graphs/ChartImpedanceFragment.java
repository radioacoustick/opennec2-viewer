...
/**
 * A fragment containing a MPAndroidChart widget for displaying Impedance graph
 */
public class ChartImpedanceFragment extends Fragment {

	public ChartImpedanceFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View root = inflater.inflate(R.layout.fragment_chart_impedance, container, false);
		LineChart chartZ = root.findViewById(R.id.impedance_line_chart);
		MaterialChartRenderer chartRenderer = new MaterialChartRenderer(chartZ);
